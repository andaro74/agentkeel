...
| Path | Seat | Gate |
|---|---|---|
| `SPEC/**`, `milestones/**`, `CLAUDE.md`, `.claude/skills/**`, `docs/**` | Product | `ruling-cited` |
...
| `src/**`, `scripts/**`, `Makefile`, `pyproject.toml`, `uv.lock`, `.python-version`, `.gitignore` | Engineering | `cold-review-ruling` |
