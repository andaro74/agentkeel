...
|---|---|---|---|
| [M00 — Start from nothing](M00.md) | Before any guardrail, a plain model gets the trick questions wrong; every later number is measured against that. | OPEN | not recorded |
