...
| [M01 — Nothing runs unsigned](M01.md) | An agent can only be deployed from a build the pipeline signed; a changed byte, or a laptop, is refused. | OPEN | not recorded |
