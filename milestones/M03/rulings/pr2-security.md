...
| F3 | nothing shows the deployed stacks equal the tree | **confirmed by the human** (`a9c8ff6`): `cdk diff` of both stacks at the head, no differences; the output not pasted, a weaker witness |
