...
| Seeded commit | `22b5499` (F0.1 plant); `f9f1342` (F0.2 seed). `22b5499` on `m00-pr1` is the plant. Goldens `g-001` to `g-015`, `data/` and the baseline code are from `8a31e8d`; the baseline prompt is as revised once in `22b5499`. |
